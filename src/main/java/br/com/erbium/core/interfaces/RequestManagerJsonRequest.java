/**
 * Class Name: RequestManagerJsonRequest
...
public interface RequestManagerJsonRequest {
     ...
     */
    RequestManagerJsonRequest setBody(@NonNull String body);
     ...
     * @return This IJsonRequest instance for chaining calls.
     */
    RequestManagerJsonRequest setMap(String jsonPath, Map<String, Object> objectValue);
    RequestManagerJsonRequest setBoolean(String jsonPath, Boolean objectValue);
    RequestManagerJsonRequest setNumber(String jsonPath, Object objectValue);
     ...
     * @return This IJsonRequest instance for chaining calls.
     */
    RequestManagerJsonRequest setList(String jsonPath, List<Object> arrayValue);
     ...
     * @return This IJsonRequest instance for chaining calls.
     */
    RequestManagerJsonRequest setString(String jsonPath, String value);
     ...
     * @return This IJsonRequest instance for chaining calls.
     */
    RequestManagerJsonRequest setInteger(String jsonPath, Integer value);
     ...
     * @return This IJsonRequest instance for chaining calls.
     */
    RequestManagerJsonRequest setLong(String jsonPath, Long value);
     ...
     * @return This IJsonRequest instance for chaining calls.
     */
    RequestManagerJsonRequest setDouble(String jsonPath, Double value);
     ...
     */
    RequestManagerJsonRequest setJsonObject(String jsonPath, String value);
     ...
     */
    RequestManagerJsonRequest setJsonArray(String jsonPath, String value);
     ...
     */
    RequestManagerJsonRequest addToJsonArray(String jsonPath, String value);
     ...
     * @return This IJsonRequest instance for chaining calls.
     */
    RequestManagerJsonRequest deleteFromJsonArray(String jsonPath, String value);
     ...
     * @return This IJsonRequest instance for chaining calls.
     */
    RequestManagerJsonRequest removeIfValueIsNull(String jsonPath);

    /**
     * Removes all null properties recursively from the entire JSON request body.
     * @return This IJsonRequest instance for chaining calls.
     */
    RequestManagerJsonRequest removeAllNulls();
    ...
    RequestManagerJsonRequest createProperty(String s);
}